...
manifest作成。manifestの詳細は [こちら](https://docs.vmware.com/en/VMware-Tanzu-SQL-with-Postgres-for-Kubernetes/1.7/tanzu-postgres-k8s/GUID-postgres-crd-reference.html) を参照。
```yaml
...
右上のℹ️ボタンを押すとPostgreSQLがバインドされていることがわかる
